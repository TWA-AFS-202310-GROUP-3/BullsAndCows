...
namespace BullsAndCowsTest
{
    public class BullsAndCowsGameTest
    {
        ...
        [Theory]
        [InlineData("1243")]
        public void Should_return_2A2B_when_guess_given_guess_number_have_four_correct_but_different_positions(string guessNumber)
        {
            //Given
            string secret = "1234";
            Mock<SecretGenerator> mockedSecretGenerator = new Mock<SecretGenerator>();
        ...
        [Theory]
        [InlineData("5612")]
        public void Should_return_0A2B_when_guess_given_guess_number_have_four_correct_but_different_positions(string guessNumber)
        {
            //Given
            string secret = "1234";
            Mock<SecretGenerator> mockedSecretGenerator = new Mock<SecretGenerator>();
